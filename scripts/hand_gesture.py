    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                distance_finger = distance_finger_calc(cx, cy, debug_image, hand_landmarks)
                gesture = gesture_detect(cx, cy, distance_finger, brect)
...
def distance_finger_calc(cx, cy, image, landmarks):
    image_width, image_height = image.shape[1], image.shape[0]
    center = [cx, cy]
    ...
    distance_finger = []
    distance_finger.append(distance_between_points(center, landmark_point[4]))#親指の指先と重心の距離　
    distance_finger.append(distance_between_points(center, landmark_point[8]))#人差し指の指先と重心の距離　
    distance_finger.append(distance_between_points(center, landmark_point[12]))#中指の指先と重心の距離　
    distance_finger.append(distance_between_points(center, landmark_point[16]))#薬指の指先と重心の距離　
    distance_finger.append(distance_between_points(center, landmark_point[20]))#小指の指先と重心の距離　
    distance_finger.append(distance_between_points(center, landmark_point[3]))#親指の第1関節と重心の距離　
    distance_finger.append(distance_between_points(center, landmark_point[6]))#人差し指の第2関節と重心の距離　
    distance_finger.append(distance_between_points(center, landmark_point[10]))#中指の第2関節と重心の距離　
    distance_finger.append(distance_between_points(center, landmark_point[14]))#薬指の第2関節と重心の距離　
    distance_finger.append(distance_between_points(center, landmark_point[18]))#小指の第2関節と重心の距離　

    return distance_finger

def gesture_detect(cx, cy, distance_finger, brect):
    gesture = 'None'
    is_finger_open = []
